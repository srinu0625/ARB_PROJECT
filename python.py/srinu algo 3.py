                        ...
                        if current_date2 == current_date1 == current_date3:
                            try:
                               ...
                               # case 1 for data2-----------------------------------------------------------------------------------
                                ...
                                if (current_high1 > local_high1) and (local_low1 > local_high2) or (local_low1 > local_high3) or (local_high1 > current_high3) and (local_low1 > local_low2) and (local_low1 > local_low3) and (local_low1 > current_low3):
                                ...
                                # bearish candle-------------------------------------------------------------------------
                                max_loss_for_trade = (local_high1 - local_low1 + ( tick_val * 4)) * contract_size
                                if (current_low1 < local_low1) and (local_high1 < local_low2) or (local_high1 < local_low3) or (local_high1 < current_low3) and (local_high1 < local_high2) and (local_high1 < local_high3)  and (local_high1 < current_low3):
                                    print("1 = hourly","2 = daily")
