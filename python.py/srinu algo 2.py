        ...
        for index2, row2 in data2.iterrows():
            ...
            if pd.notna(row2[time_column_name]) and pd.notna(row2[high_column_name]) and pd.notna(row2[low_column_name]):
                ...
                if current_date2 == current_date1:
                    ...
                    if ((local_high1 > local_high2) or (current_high1 > local_high1) and local_high1 != 0 and local_low1 != 0 and local_high2 != 0 and local_low2 != 0 and not bear and not flag):
