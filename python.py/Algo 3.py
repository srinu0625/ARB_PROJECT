...
for index1, row1 in data1.iterrows():
    ...
    # case 1 for data2-----------------------------------------------------------------------------------
        ...
        # bearish candle-------------------------------------------------------------------------
        max_loss_for_trade = (local_high1 - current_low1 + ( tick_val * 4)) * contract_size
        if (current_high1 < local_low1) and ((local_high1 < local_low2) or (local_high1 < local_low3) or (local_high1 < current_low3)) and ((local_high1 < local_high2) and (local_high1 < local_high3) and (local_high1 < current_high3)) and not bull and not flag:
            if max_loss_for_trade > risk:
                   num_of_lots = 1
